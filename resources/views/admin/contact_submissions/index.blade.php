<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-[#161b22] shadow-sm rounded-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
                    ...
                    @forelse ($submissions as $submission)
                        <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors {{ !$submission->is_read ? 'bg-blue-50/50 dark:bg-blue-900/10' : '' }}">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-200">
                                        Read
                                    </span>
                                @endif
                            </td>
