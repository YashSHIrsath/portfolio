<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto py-8">
        ...
        <div class="bg-white dark:bg-[#161b22] shadow rounded-lg p-6 border border-slate-200 dark:border-slate-800">
            <form action="{{ route('admin.bios.store') }}" method="POST">
                @csrf
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10" class="mt-1 block w-full rounded-md border-slate-300 dark:border-slate-700 dark:bg-[#0d1117] dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="I am a developer..." required></textarea>
                    </div>
