        ...
        <div class="bg-white dark:bg-[#161b22] shadow rounded-lg border border-slate-200 dark:border-slate-800 p-6">
            ...
            <form action="{{ route('admin.tech-stacks.update', $techStack) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="category" list="category-options" value="{{ old('category', $techStack->category) }}" class="w-full px-3 py-2 border rounded-md dark:bg-[#0d1117] dark:border-slate-700 dark:text-slate-100 focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Frontend, Backend..." required>
